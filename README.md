...
Objetivo: fazer com que as rodas do carrinho girassem quando os sensores detectassem algo - testar implementação dos sensores em conjunto com a ponte H

Resultado: Quando os sensores detectavam algo, uma das rodas ou ambas (caso os dois sensores detectassem ao mesmo tempo) giravam. Os LEDs também piscavam para evidenciar essa funcionalidade.
...
Objetivo dos Commits 2, 3 e 5: fazer o carrinho andar na pista
---
Commit 2
